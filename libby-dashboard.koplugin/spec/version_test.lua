...
assert(Version.parse("0.2.8").component_count == 3)
assert(Version.parse("0.2.8.0").component_count == 4)
...
assert(Version.is_newer("0.2.8.0", "0.2.8") == true)
assert(Version.is_newer("0.2.8", "0.2.8.0") == false)
assert(Version.is_newer("0.2.8.1", "0.2.8.0") == true)
